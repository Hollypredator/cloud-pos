...
/**
 * Kasada masayi kroki uzerinden sectirir.
 *
 * Liste gorunumu hizli ama garson salonu isimle degil YERLE hatirliyor
 * ("pencere kenari"). Kroki, /admin/tables/floor-plan'da kurulan yerlesimi
 * ayni koordinatlarla gosterir; konum kaydedilmemis masalar izgaraya duser.
 */
...
export function TablePickerFloorPlan({
  ...
  // Arama masalari filtreledikce aktif bolge sekmesi yok olabilir; o durumda
  // ilk mevcut sekmeye duser, yoksa ekran bos gorunurdu.
