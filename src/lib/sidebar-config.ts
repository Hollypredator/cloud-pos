...
export const operationLinks: SidebarNavItem[] = [
  ...
  { href: "/admin/audit", label: "İşlem Logları", icon: "LG", roles: ["admin"], feature: "audit_logs", businessTypes: ["restaurant_cafe"] },
  ...
  { href: "/admin/tables", label: "Bölge ve Masa", icon: "MS", roles: ["admin"], businessTypes: ["restaurant_cafe"] },
