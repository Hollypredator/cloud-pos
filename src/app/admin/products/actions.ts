...
/**
 * /admin/products sunucu aksiyonlari.
 *
 * page.tsx'ten ayrildi: dosya 2900 satira ulasmisti ve arayuz kodu ile 24
 * mutasyon ic ice geciyordu. Bu modul yalnizca yazma yolunu tutar; ekranda
 * ne gorundugu page.tsx'in isi.
 *
 * Not: "use server" modullerinde YALNIZCA async fonksiyon disa aktarilabilir.
 * Yardimci fonksiyonlar ve demo katalog tohumu bilerek export edilmedi.
 */
...
export async function saveModifierEffectsAction(
  optionId: string,
  effects: Array<{
