...
export default async function OpsPage() {
  ...
  return (
    <BackofficePage
      ...
      actions={
        <>
          <span className="inline-flex rounded-full bg-slate-900 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-white">
            Rol {roleLabel}
          </span>
          {usingDemoData ? (
            <span className="inline-flex rounded-full bg-amber-100 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-amber-800">
              Demo veri acik
            </span>
          ) : null}
        ...
        <div className="space-y-5">
          ...
          <SidebarPanel title="Anlik Durum" description="Bugunku operasyon nabzi ve risk odaklari.">
            <div className="rounded-[24px] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-5 text-white">
              ...
              <p className="mt-4 text-4xl font-semibold tracking-tight">{formatCurrency(metrics.todayRevenue)}</p>
