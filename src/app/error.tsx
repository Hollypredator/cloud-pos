  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 text-center shadow-sm">
        <h1 className="text-2xl font-semibold text-slate-900">Bir hata olustu</h1>
        <p className="mt-2 text-sm text-slate-600">Islem tamamlanamadi. Lutfen tekrar deneyin.</p>
        <button
          type="button"
          onClick={reset}
