  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 text-center shadow-sm">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-slate-900">Sayfa bulunamadi</h1>
        <p className="mt-2 text-sm text-slate-600">Yazdigin rota gecersiz olabilir veya aradigin sayfa kaldirilmis olabilir.</p>
